...
export const metadata: Metadata = {
  ...
  description:
    'Generate Doctrine XML mappings and PHP entities from SQL CREATE TABLE statements. Free online tool for converting database schemas to Doctrine ORM entities with customizable options.',
  keywords: [
    'doctrine',
    'doctrine orm',
  ...
  openGraph: {
    ...
    description:
      'Generate Doctrine XML mappings and PHP entities from SQL CREATE TABLE statements. Free online tool for converting database schemas to Doctrine ORM entities.',
